      ...
      <div className=" rounded-2xl">
        <div className="flex flex-col lg:flex-row gap-5 items-center w-full lg:px-10 p-9 bg-green-300/35 rounded-2xl ">
          ...
          <div className="flex flex-col gap-4 text-center lg:text-left lg:flex-1">
            ...
            Shielding your heart and recovering from such a traumatic incident may be up to you, but healing from your financial losses gets easier with us. We know that trusting the process may not come effortlessly; hence we keep our operations transparent and efficient.
            </p>
            <p className="text-sm  font-bold text-white lg:w-[500px]">
            Mastering the best of innovations in the financial world, we come forth as a scam recovery agency that lives up with a tall success rate. Despite our accomplishments, our every endeavor is a step towards making sure that victims retrieve a majority of their lost resources. Our investigative powers keep us marching forward, all with a strategic recovery plan that in most scams result fruitfully. If you’ve been tricked into an online dating fraud, don’t be shattered. Join hands with us as we get on towards empowering you. 
            </p>
