...
import { forexScam } from '../../../data';

const ForexScamData = () => {
    const [forexScamData] = useState(forexScam);
    const [index, setIndex] = useState(0);
    const [activeTab, setActiveTab] = useState(0);
    const currentServices = forexScamData[index];
  ...
  return (
    ...
    <div>
      <div className="flex flex-col justify-center items-center gap-7 bg-green-900 py-8 px-3 lg:px-8">
        ...
        <p className="text-sm sm:text-lg font-bold text-white lg:w-[500px] text-center"> The Forex market trades trillions of dollars daily, making it hard to regulate every trade. This makes it easy for scammers to trick people into financial mistakes. Our Forex scam recovery specialists work to protect your financial interests and recover as much of your lost funds as possible.</p>
        </div>
