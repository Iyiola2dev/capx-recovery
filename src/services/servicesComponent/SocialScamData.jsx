...
import { socialMediaScam } from "../../../data";

const SocialScamData = () => {
  const [socialMediaScamData] = useState(socialMediaScam);
  const [index, setIndex] = useState(0);
  const [activeTab, setActiveTab] = useState(0);
  const currentServices = socialMediaScamData[index];
    ...
    <div>
      <div className="flex flex-col justify-center items-center gap-7 bg-green-900 py-8 px-3 lg:px-8">
        <div className="flex flex-col">
          ...
          Detect Trending Social Media Frauds
          </h1>
          <p className="text-sm sm:text-lg font-bold text-white lg:w-[500px] text-center">
           
            These charlatans use social media to win the trust and confidence of their potential victims. Some prominent social media scams trending in our society are listed below:
          </p>
        </div>
