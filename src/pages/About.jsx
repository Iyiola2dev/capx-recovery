  ...
  return (
    <div className="bg-green-300/35   px-8 py-10 flex flex-col items-center ">
      ...
      <div className="  flex flex-col items-center py-10 gap-5 rounded-2xl">
        <h1 className="text-3xl md:text-5xl font-bold text-[#ffdb8a]">About us</h1>
        <p className="text-lg md:text-2xl font-semibold text-white text-center  md:w-[600px]">
          At Capx Recovery, we understand that cryptocurrency can be complex and
          risky. If you’ve lost money, faced security issues, or need help
      ...
      <div className="flex flex-col lg:flex-row bg-blue-900 items-center py-10 px-3 gap-4">
